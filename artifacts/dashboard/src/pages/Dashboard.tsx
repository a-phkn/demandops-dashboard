...
function computeActiveSignals(
  ...
  const settingMult = setting === "Urban" ? 1.12 : 0.9;
  active.push({
    id: "setting",
    icon: setting === "Urban" ? Building2 : Tractor,
    name: `${setting} Context`,
    desc:
      setting === "Urban" ? "High density area" : "Lower density, bulk demand",
    multiplier: settingMult,
    ...HUE.blue,
    barColor: HUE.blue.bar,
    detail: "Adjusts baseline demand based on store geographic density.",
    urgency: "low",
    daysAway: 0,
  });
  ...
  if (nextFest) {
    ...
    active.push({
      id: "festival",
      icon: ICON_MAP[nextFest.iconKey.toLowerCase()] || Star,
      name: nextFest.name,
      desc:
        nextFest.daysAway === 0
          ? "Today!"
          : nextFest.daysAway === 1
            ? "Tomorrow"
            : `${nextFest.daysAway} days away`,
      multiplier: nextFest.mult,
      color,
      bg,
      barColor: bar,
      detail: "Major regional driver for staples and gifting items.",
      urgency:
        nextFest.daysAway <= 3
          ? "critical"
          : nextFest.daysAway <= 7
  ...
  if (day <= 7)
    active.push({
      ...
      icon: Wallet,
      name: "Salary Week",
      desc: `Post-salary · day ${day}`,
      multiplier: 1.25,
      ...HUE.violet,
      barColor: HUE.violet.bar,
      detail: "First 7 days post-salary see a 25% demand surge.",
      urgency: "medium",
      daysAway: 0,
    });
  if (day >= 25)
    active.push({
      id: "presalary",
      icon: Wallet,
      name: "Pre-Salary Surge",
      desc: "Month-end stock-up",
      multiplier: 1.1,
      ...HUE.indigo,
      barColor: HUE.indigo.bar,
      detail: "Families stock up ahead of salary credit.",
      urgency: "low",
      daysAway: 0,
    });
  if (wd === 5 || wd === 6)
    active.push({
      ...
      desc: "Peak shopping day",
      multiplier: wd === 6 ? 1.22 : 1.15,
      ...HUE.amber,
      barColor: HUE.amber.bar,
      detail: "Weekends see higher footfall.",
      urgency: "medium",
      daysAway: 0,
    });
  if (month >= 5 && month <= 8)
    active.push({
      ...
      icon: CloudRain,
      name: "Monsoon Season",
      desc: "Active rain shift",
      multiplier: 1.18,
      ...HUE.sky,
      barColor: HUE.sky.bar,
      detail: "Boosts home consumption staples.",
      urgency: "low",
      daysAway: 0,
    });
  if (month >= 2 && month <= 4)
    active.push({
      ...
      multiplier: 1.15,
      ...HUE.orange,
      barColor: HUE.orange.bar,
      detail: "Cold drinks and dairy spike.",
      urgency: "low",
      daysAway: 0,
    });
  if (month >= 10 || month === 0)
    active.push({
      ...
      ...HUE.blue,
      barColor: HUE.blue.bar,
      detail: "Winter drives demand for dry fruits and ghee.",
      urgency: "low",
      daysAway: 0,
    });
  ...
  if (active.length === 0)
    active.push({
      ...
      bg: "bg-muted",
      barColor: "#9ca3af",
      detail: "Standard forecast applies.",
      urgency: "low",
      daysAway: 0,
    });
...
const GLASS_BUBBLES: GlassBubble[] = [
  {
    ...
    size: 88,
    iconSize: 32,
    lightBg: "rgba(219,234,254,0.55)",
    darkBg: "rgba(37,99,235,0.18)",
    lightBorder: "rgba(147,197,253,0.6)",
  ...
  },
  {
    ...
    size: 76,
    iconSize: 28,
    lightBg: "rgba(209,250,229,0.55)",
    darkBg: "rgba(5,150,105,0.18)",
    lightBorder: "rgba(110,231,183,0.6)",
  ...
  },
  {
    ...
    size: 96,
    iconSize: 36,
    lightBg: "rgba(254,243,199,0.55)",
    darkBg: "rgba(217,119,6,0.18)",
    lightBorder: "rgba(252,211,77,0.6)",
  ...
  },
  {
    ...
    size: 80,
    iconSize: 30,
    lightBg: "rgba(252,231,243,0.55)",
    darkBg: "rgba(190,24,93,0.15)",
    lightBorder: "rgba(249,168,212,0.6)",
  ...
  },
  {
    ...
    size: 70,
    iconSize: 26,
    lightBg: "rgba(237,233,254,0.55)",
    darkBg: "rgba(124,58,237,0.18)",
    lightBorder: "rgba(196,181,253,0.6)",
  ...
  },
  {
    ...
    size: 82,
    iconSize: 30,
    lightBg: "rgba(255,237,213,0.55)",
    darkBg: "rgba(234,88,12,0.18)",
    lightBorder: "rgba(253,186,116,0.6)",
  ...
  },
  {
    ...
    size: 64,
    iconSize: 24,
    lightBg: "rgba(204,251,241,0.55)",
    darkBg: "rgba(13,148,136,0.18)",
    lightBorder: "rgba(94,234,212,0.6)",
    darkBorder: "rgba(45,212,191,0.25)",
    iconColor: "#0d9488",
    top: "28%",
    right: "18%",
    ax: [0, -12, 2, 0],
  ...
  },
  {
    ...
    size: 72,
    iconSize: 26,
    lightBg: "rgba(219,234,254,0.50)",
    darkBg: "rgba(30,64,175,0.16)",
    lightBorder: "rgba(147,197,253,0.5)",
    darkBorder: "rgba(96,165,250,0.20)",
    iconColor: "#1d4ed8",
    bottom: "32%",
    right: "28%",
    ax: [0, -14, -4, 0],
    ...
    <>
      <div
        style={{
          ...
          zIndex: 0,
          pointerEvents: "none",
          background: isDark ? "hsl(222,47%,5%)" : "hsl(218,38%,93%)",
        }}
        aria-hidden
      />
      <div
        ...
        {GLASS_BUBBLES.map((b) => (
          ...
          >
            ...
            <b.Icon
              size={b.iconSize}
              strokeWidth={1.5}
              color={isDark ? b.iconColor : b.iconColor}
            />
          </motion.div>
        ))}
      </div>
...
export default function Dashboard() {
  ...
  const [dynamicLocations, setDynamicLocations] =
    useState<Record<string, string>>(INITIAL_LOCATIONS);
  ...
  const activeSignals = useMemo(
    () => computeActiveSignals(currentDate, userRegion, currentSetting),
    [currentDate, currentLocation, currentSetting, dynamicLocations],
  );
  const combinedMult = useMemo(
    () => activeSignals.reduce((a, s) => a * s.multiplier, 1),
    [activeSignals],
  );
  const displayRows = useMemo(
    () => computeRows(products, combinedMult),
    [products, combinedMult],
  );

  const formattedTime = realTime.toLocaleTimeString("en-IN", {
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit",
    hour12: true,
  ...
  const updateStock = async (id: number, stock: number | undefined) => {
    ...
    try {
      const response = await fetch("/api/stock/update", {
        ...
        body: JSON.stringify({ product_id: id, new_stock: stock || 0 }),
      });
      if (response.ok) {
        const updatedData = await fetch("/api/inventory").then((res) =>
          res.json(),
        );
  ...
  const lowStockAlerts = displayRows
    .filter(
      (r) =>
        r.stock !== undefined && r.stock < r.finalNum * 0.5 && r.responsive,
    )
    .sort((a, b) => a.stock! / a.finalNum - b.stock! / b.finalNum)
    .slice(0, 2);
  const sortedLocations = Object.keys(dynamicLocations).sort((a, b) =>
    a.localeCompare(b),
  );
  ...
  const glassPanel =
    "bg-white/12 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10";
  const glassHeader =
    "bg-white/15 dark:bg-white/6 backdrop-blur-2xl border-b border-white/20 dark:border-white/10";

  return (
    <div
      className="relative flex flex-col h-screen max-h-screen text-foreground overflow-hidden"
      style={{ zIndex: 2 }}
    >
      <DynamicBackground />
      ...
      {/* ── Header ── */}
      <header
        className={`relative z-10 flex-none h-14 ${glassHeader} flex items-center px-5 gap-4`}
      >
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          >
            ...
            <span className="text-foreground/70">Ops</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-1">
          <div className="flex items-center gap-1.5">
            ...
            >
              <SelectTrigger
                className="w-[155px] h-8 text-xs bg-white/20 dark:bg-white/5 border-white/25 dark:border-white/10 backdrop-blur-sm"
          ...
          <Button
            variant="ghost"
            size="sm"
            className="h-8 px-2.5 text-xs gap-1.5 bg-white/10 dark:bg-white/5 hover:bg-white/20 dark:hover:bg-white/10 border border-white/20 dark:border-white/10"
            onClick={handleGps}
          ...
          >
            {isGpsLoading ? (
              ...
              <MapPin
                className={`w-3 h-3 ${gpsUsed ? "text-primary" : "text-muted-foreground"}`}
              />
            )}
          ...
          <div className="flex items-center gap-2 px-3 h-8 bg-white/15 dark:bg-white/5 border border-white/25 dark:border-white/10 rounded-lg backdrop-blur-sm">
            ...
            />
            <span className="text-[9px] text-muted-foreground uppercase tracking-tight border-l border-border/40 pl-2 hidden sm:block">
              Sim Date
            </span>
          </div>
          ...
          <Select value={currentSetting} onValueChange={setCurrentSetting}>
            <SelectTrigger
              className="w-[110px] h-8 text-xs bg-white/15 dark:bg-white/5 border-white/25 dark:border-white/10 backdrop-blur-sm"
              style={{ fontFamily: FONT_DISPLAY }}
            >
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 bg-white/10 dark:bg-white/5 hover:bg-white/20 dark:hover:bg-white/10 border border-white/20 dark:border-white/10"
          ...
          <Button
            variant="outline"
            size="icon"
            className="h-8 w-8 bg-white/10 dark:bg-white/5 border-white/25 dark:border-white/10"
            onClick={toggleTheme}
      ...
      {/* ── Stats Strip ── */}
      <div
        className={`relative z-10 flex-none border-b border-white/15 dark:border-white/8 bg-white/8 dark:bg-white/3 backdrop-blur-lg px-5 py-2 flex gap-4`}
      >
        {[
          {
            label: "Store",
          ...
          {
            label: "Combined Uplift",
            value: `×${combinedMult.toFixed(2)}`,
            sub: `${activeSignals.length} signals active`,
            icon: TrendingUp,
            accent: true,
          },
          {
            label: "Total Forecast",
            value: `${totalForecastUnits}`,
            sub: "units today",
            icon: BarChart2,
            accent: false,
          },
          ...
          },
          {
            label: "Alerts",
            value: `${alertCount}`,
            sub: alertCount === 0 ? "all clear" : "need attention",
            icon: AlertTriangle,
            accent: alertCount > 0,
          },
        ].map((stat) => (
          <div
            key={stat.label}
            className={`flex items-center gap-2.5 px-3 py-1.5 rounded-lg border ${stat.accent ? "border-primary/30 bg-primary/8 dark:bg-primary/12" : "border-white/15 dark:border-white/8 bg-white/8 dark:bg-white/4"}`}
          >
            <stat.icon
              className={`w-3.5 h-3.5 shrink-0 ${stat.accent ? "text-primary" : "text-muted-foreground"}`}
            />
            <div>
              <div
                className={`text-xs font-bold ${stat.accent ? "text-primary" : "text-foreground"}`}
                style={{ fontFamily: FONT_MONO }}
              >
                {stat.value}
              </div>
      ...
      <main className="relative z-10 flex-1 flex min-h-0">
        {/* Sidebar */}
        <aside
          className={`w-68 border-r border-white/15 dark:border-white/8 ${glassPanel} p-4 flex flex-col gap-3 overflow-y-auto`}
          style={{ width: "17rem" }}
        >
          <div>
            <div className="flex items-center justify-between mb-2.5">
              ...
              <Badge
                variant="secondary"
                className="text-[9px] h-4 px-1.5 bg-primary/15 text-primary border-primary/20"
                style={{ fontFamily: FONT_MONO }}
              >
          ...
          <div className="mt-auto pt-2 border-t border-white/15 dark:border-white/8">
            <div className="p-3 rounded-xl bg-primary/10 dark:bg-primary/15 border border-primary/20">
              ...
              <p
                ...
                style={{ fontFamily: FONT_DISPLAY }}
              >
                {activeSignals.length} signal
                {activeSignals.length !== 1 ? "s" : ""} pushing demand to{" "}
                <span
        ...
        <div className="flex-1 p-5 flex flex-col min-h-0">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: FONT_DISPLAY }}
              >
                Hover final quantities for multiplier breakdown · Click rows to
                pin
              </p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div
                className={`flex items-center gap-1.5 text-xs text-muted-foreground ${glassPanel} rounded-lg px-3 py-1.5`}
              >
          ...
          <div
            className={`flex-1 overflow-auto rounded-2xl border border-white/20 dark:border-white/10 shadow-lg bg-white/20 dark:bg-white/4 backdrop-blur-xl`}
          >
            <Table>
                  ...
                  {displayRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <div className="flex items-center gap-1.5 flex-wrap">
                                ...
                                {row.risk === "High Risk" && (
                                  <Badge
                                    variant="destructive"
                                    className="h-3.5 px-1.5 text-[8px] uppercase font-bold tracking-wider animate-pulse"
                                  >
                                    ⚠ High Risk
                                  </Badge>
                                )}
                        ...
                        {/* ── Base Qty ── */}
                        <TableCell
                          className="text-right text-sm text-muted-foreground py-3"
                          style={{ fontFamily: FONT_MONO }}
                        >
                          {row.base}
                        </TableCell>
                        ...
                        <TableCell className="text-right py-3">
                          <Tooltip>
                            ...
                            <TooltipContent
                              side="left"
                              className="bg-popover border border-border p-3.5 max-w-xs shadow-xl rounded-xl"
                              sideOffset={8}
                            >
                              {!row.responsive ? (
                                <p
                                  ...
                                  style={{ fontFamily: FONT_DISPLAY }}
                                >
                                  No multipliers applied — quantity unchanged.
                                </p>
                              ) : (
      ...
      {/* ── Alerts Footer ── */}
      <footer
        className={`relative z-10 flex-none border-t border-white/15 dark:border-white/8 ${glassPanel} px-5 py-2.5 flex gap-3`}
      >
        {expiryAlerts.map((r) => (
          <AlertCard
            key={r.id}
        ...
        {lowStockAlerts.map((r) => {
          const daysCover =
            r.stock !== undefined && r.finalNum > 0
              ? Math.round(r.stock / (r.finalNum / 7))
              : 0;
          return (
            <AlertCard
              key={r.id}
              ...
              message={`Stock covers ~${daysCover} days at ×${combinedMult.toFixed(2)} demand. Reorder now.`}
        ...
        {expiryAlerts.length === 0 && lowStockAlerts.length === 0 && (
          <div className="flex-1 flex items-center gap-2 text-xs text-emerald-600 dark:text-emerald-400">
            ...
            <span style={{ fontFamily: FONT_DISPLAY }}>
              All stock levels healthy — no alerts today.
            </span>
          </div>
        )}
      </footer>
      ...
      >
        <div className="p-3">
          <div className="flex items-start gap-2.5">
            <div
              className={`relative mt-0.5 p-1.5 rounded-lg ${signal.bg} ${signal.color} shrink-0`}
            >
              <Icon className="w-3.5 h-3.5" />
              {(signal.urgency === "critical" || signal.urgency === "high") && (
                <span
                  className={`absolute -top-1 -right-1 w-1.5 h-1.5 rounded-full border border-background ${signal.urgency === "critical" ? "bg-rose-500 animate-pulse" : "bg-amber-400"}`}
                />
              )}
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <Badge
                    variant="secondary"
                    className="bg-primary/12 text-primary border-primary/20 text-[9px] px-1 h-3.5"
                    style={{ fontFamily: FONT_MONO }}
                  >
                    ×{signal.multiplier}
                  </Badge>
          ...
          <AnimatePresence>
            {expanded && (
              ...
              >
                <p
                  className="text-[10px] text-muted-foreground mt-2.5 pt-2.5 border-t border-white/15 dark:border-white/8 leading-relaxed"
                  style={{ fontFamily: FONT_DISPLAY }}
                >
                  {signal.detail}
                </p>
    ...
    <div className="p-3 rounded-xl bg-primary/8 dark:bg-primary/12 border border-primary/18">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <span
            className="text-[9px] font-bold uppercase tracking-widest text-primary"
            style={{ fontFamily: FONT_DISPLAY }}
          >
            Demand Pulse
          </span>
      ...
      <div className="flex items-end justify-center gap-[3px] h-9 my-1.5 px-1">
        {Array.from({ length: BARS }, (_, i) => {
          ...
          const r = i / (BARS - 1);
          const barColor =
            r < 0.45 ? "#10b981" : r < 0.72 ? "#f59e0b" : "#ef4444";
          return (
            <motion.div
              key={i}
              ...
              style={{
                height: `${h}%`,
                backgroundColor: lit ? barColor : "rgba(0,0,0,0.08)",
              }}
              initial={{ scaleY: 0 }}
              animate={{ scaleY: lit ? 1 : 0.25, opacity: lit ? 1 : 0.22 }}
      ...
      <div className="flex items-center justify-between">
        <span
          ...
          style={{ color: labelColor, fontFamily: FONT_DISPLAY }}
        >
          {label}
        </span>
      ...
      >
        {events.map((f) => {
          ...
          return (
            ...
            >
              <div
                className={`p-1.5 rounded-lg ${bg} ${color} shadow-sm group-hover:rotate-12 transition-transform shrink-0`}
              >
                <Icon className="w-3 h-3" />
              </div>
              <div className="flex-1 min-w-0">
                <p
                  className="text-[11px] font-bold truncate group-hover:text-primary transition-colors"
                  style={{ fontFamily: FONT_DISPLAY }}
                >
                  {f.name}
                </p>
              ...
              <div className="text-right shrink-0">
                <span
                  ...
                  style={{ fontFamily: FONT_MONO, color: bar }}
                >
                  ×{f.mult}
                </span>
                <p className="text-[9px] text-muted-foreground whitespace-nowrap">
                  {f.daysAway === 0 ? "TODAY" : `in ${f.daysAway}d`}
                </p>
              </div>
            </motion.div>
          );
...
function StockCell({
  ...
  const pct =
    s !== undefined && needed > 0 ? Math.round((s / needed) * 100) : null;
  const cls =
    s === undefined
  ...
  return (
    ...
    >
      ...
      {pct !== null && (
        <span
          className={`text-[9px] font-bold px-1 py-0.5 rounded ${s! < needed * 0.5 ? "bg-rose-100/80 text-rose-600 dark:bg-rose-500/15 dark:text-rose-400" : s! < needed ? "bg-amber-100/80 text-amber-600 dark:bg-amber-500/15 dark:text-amber-400" : "bg-emerald-100/80 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-400"}`}
          style={{ fontFamily: FONT_MONO }}
        >
          {pct}%
        </span>
...
function AddProductModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const stock =
      stockQty.trim() !== ""
        ? Math.max(0, parseFloat(stockQty) || 0)
        : undefined;
    onAdd({
      id: Date.now(),
      product: name.trim(),
  ...
  const forecastNum =
    baseQty && parseFloat(baseQty) > 0
      ? Math.round(parseFloat(baseQty) * combinedMult)
      : null;
  const stockNum = stockQty.trim() !== "" ? parseFloat(stockQty) : null;
  const coverPct =
    forecastNum && stockNum !== null
      ? Math.round((stockNum / forecastNum) * 100)
      : null;
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          <DialogTitle
            style={{ fontFamily: FONT_PLAYFAIR, fontSize: "1.2rem" }}
          >
            Add Product
          </DialogTitle>
          <DialogDescription
            ...
            style={{ fontFamily: FONT_DISPLAY }}
          >
            Forecast applies all active signal multipliers (×
            {combinedMult.toFixed(2)}).
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-3.5 pt-1">
          ...
          <AnimatePresence>
            {forecastNum && (
              <motion.div
                ...
                style={{
                  background:
                    coverPct !== null && coverPct < 50
                      ? "rgb(254 242 242 / 0.7)"
                      : coverPct !== null && coverPct < 100
                        ? "rgb(255 251 235 / 0.7)"
                        : "rgb(240 253 244 / 0.7)",
                  borderColor:
                    coverPct !== null && coverPct < 50
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <Button
              type="submit"
              size="sm"
              disabled={!name.trim() || !baseQty || parseFloat(baseQty) < 0}
            >
  ...
  return (
    <AnimatePresence>
      {!dismissed && (
        ...
        >
          <div
            className={`shrink-0 mt-0.5 p-1.5 rounded-lg ${variant === "warn" ? "bg-amber-100/80 dark:bg-amber-500/15" : "bg-rose-100/80 dark:bg-rose-500/15"}`}
          >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p
              className={`text-[10px] mt-0.5 leading-relaxed opacity-80 ${color}`}
              style={{ fontFamily: FONT_DISPLAY }}
            >
              {message}
            </p>
